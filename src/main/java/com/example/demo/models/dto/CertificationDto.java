...
public class CertificationDto {
    ...
    public CertificationDto(Integer id ,String name ,String description,String addtional_file ,String available_start_date ,String available_end_date ,String certificationType){
        this.id = id;
        this.name = name;
